...
export function PokemonCard({ id, name, image, height, weight, types }) {
  return (
    <div className="relative border-5 border-white p-6 rounded-lg text-center w-48 bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 font-bold shadow-md hover:scale-105 transition-all">
